    ...
    <div className="min-h-screen bg-[#fbf9f8] text-[#1b1c1c]">
      <aside className="hidden min-h-screen w-64 border-r border-[#efeded] bg-white lg:fixed lg:inset-y-0 lg:left-0 lg:flex lg:flex-col">
        ...
        <nav className="flex-1 space-y-1 px-4 py-6">
          <Link className="flex min-h-12 items-center gap-3 px-4 text-sm font-bold text-[#555151] transition hover:bg-[#fbf9f8] hover:text-[#ba0013]" to="/technician/tasks">
            <Icon name="clipboard" />
            Phiếu kiểm tra
          </Link>
          <Link className="flex min-h-12 items-center gap-3 border-l-4 border-[#ba0013] bg-[#fff1f1] px-4 text-sm font-black text-[#ba0013]" to="/technician/work-orders">
            <Icon name="wrench" />
            Lệnh được giao
          </Link>
      ...
      <div className="lg:pl-64">
        <header className="sticky top-0 z-30 border-b border-[#efeded] bg-white/90 backdrop-blur-xl">
          <div className="flex min-h-20 items-center justify-between gap-4 px-5 sm:px-8 lg:px-10">
            <div>
              <p className="font-mono text-xs font-black uppercase tracking-[0.18em] text-[#ba0013]">Technician Workspace</p>
              <h1 className="text-2xl font-black text-[#171717] sm:text-3xl">Lịch cá nhân & lệnh được phân công</h1>
            </div>
            <div className="hidden items-center gap-4 sm:flex">
              <button aria-label="Thông báo" className="relative flex h-11 w-11 items-center justify-center border border-[#dedada] text-[#1b1c1c] transition hover:border-[#ba0013] hover:text-[#ba0013]" type="button">
                <Icon name="bell" />
                <span className="absolute -right-1 -top-1 flex h-5 min-w-5 items-center justify-center bg-[#ba0013] px-1 text-[10px] font-black text-white">4</span>
              </button>
